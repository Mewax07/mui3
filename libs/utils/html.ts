...
export class Html<T extends HTMLElement = HTMLElement> {
    ...
    qs(selector: string): Html | null {
        ...
        const h = Object.create(Html.prototype) as Html;
        (h as any).elm = elm;
        (h as any).listeners = new Map();
    ...
    // Insert
    append(child: Html | HTMLElement | SVGElement | string): this {
...
export class HtmlIcon extends Html<HTMLSpanElement> {
    constructor(target?: HTMLSpanElement | string) {
        super(
            (target as HTMLElement) ?? ("span" as keyof HTMLElementTagNameMap),
        );
        this.classOn("material-symbols-outlined");
    }
    ...
    constructor(target?: HTMLCanvasElement) {
        super(
            (target as HTMLElement) ??
                ("canvas" as keyof HTMLElementTagNameMap),
        );
